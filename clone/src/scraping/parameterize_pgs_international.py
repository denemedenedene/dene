...
if flight.ssInfo != None:
    driver.save_screenshot('PGSi_1.png')
    print('ss1 saved.')

try:
    driver.find_element_by_xpath('/html/body/div[7]/div/div/div[4]/ul/li[2]/a').click()
except:
    print('no click')
...
try:
    ...
    pass
if flight.ssInfo != None:
    driver.save_screenshot('PGSi_2.png')
    print('ss2 saved.')

element = driver.find_element_by_id('totalFare')
print('Ticket price: '+element.text)

driver.find_element_by_xpath('//*[starts-with(@name,"paxXbagWeigh")]').click()
driver.find_element_by_xpath('//*[starts-with(@name,"paxXbagWeigh")]').send_keys(Keys.ARROW_DOWN, Keys.ENTER)
driver.find_element_by_id('btnSubmit').click()
driver.implicitly_wait(3)
driver.find_element_by_xpath('//*[@id="modal-insurance"]/span[1]/span').click()

if flight.ssInfo != None:
    driver.save_screenshot('PGSi_3.png')
    print('ss3 saved.')
...
if flight.ssInfo != None:
    driver.save_screenshot('PGSi_4.png')
    print('ss4 saved.')
...
if flight.ssInfo != None:
    driver.save_screenshot('PGSi_5.png')
    print('ss5 saved.')
...
driver.find_element_by_xpath('/html/body/form/div[2]/div[2]/div[2]/div[11]/div[6]/div/table/tbody/tr/td[2]/a/span').click()
driver.implicitly_wait(2)

if flight.ssInfo != None:
    driver.save_screenshot('PGSi_6.png')
    print('ss6 saved.')
